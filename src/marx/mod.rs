...
#[inline(always)]
unsafe fn update_marx_item_collision(boss_boma: *mut smash::app::BattleObjectModuleAccessor) {
...
#[inline(always)]
unsafe fn marx_should_clamp_floor(boss_boma: *mut smash::app::BattleObjectModuleAccessor) -> bool {
    if !CONTROLLABLE {
        return false;
    }
...
#[inline(always)]
unsafe fn restore_marx_after_item_wipe(module_accessor: *mut BattleObjectModuleAccessor) {
    ...
    BLACK_HOLE_END = false;
    let boss_boma =
        boss_helpers::acquire_boss_item(module_accessor, &raw mut BOSS_ID, *ITEM_KIND_MARX);
                ...
                if boss_helpers::is_boss_preview_stage(stage_id) {
                        ...
                        || !ItemModule::is_have_item(module_accessor, 0)
                    {
                        ...
                        if boss_helpers::is_classic_staffroll_stage(stage_id) {
                            crate::amiibo_preview::apply_classic_staffroll_item(boss_boma, "marx");
                        } else {

...
static MASTER_HAND_NAME_HASHES: Lazy<[u64; 12]> = Lazy::new(|| {
    [
        hash40("WOL MASTER HAND"),
        hash40("MEWTWO MASTER HAND"),
        hash40("ミュウツー マスターハンド"),
        hash40("MAIN DE MAÎTRE MEWTWO"),
        hash40("MEWTWO MEISTERHAND"),
        hash40("MEWTWO MANO MAESTRA"),
        hash40("MEWTWO MAESTRA MANO"),
        hash40("MEWTWO MEESTERHAND"),
        hash40("MEWTWO МАСТЕР РУКА"),
        hash40("뮤츠 마스터 핸드"),
        hash40("超梦大师"),
        hash40("超夢大師"),
    ]
...
#[inline(always)]
fn is_master_hand_name(hash: u64) -> bool {
    MASTER_HAND_NAME_HASHES
        .iter()
...
extern "C" fn once_per_fighter_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if fighter_kind == *FIGHTER_KIND_MARIO {
            ...
            let is_master_selection = selected_hash == hash40("ui_chara_mewtwo_masterhand");
            let fallback_name_match = is_master_hand_name(FIGHTER_NAME[player_number]);

            if !(is_master_selection || (selected_hash == 0 && fallback_name_match)) {
                ...
                if smash::app::stage::get_stage_id() == 0x139 {
                    ...
                    if ModelModule::scale(module_accessor) != 0.0001 {
                        ...
                        ) == true
                        {
                            ...
                            ItemModule::have_item(
                                module_accessor,
                                ItemKind(*ITEM_KIND_PLAYABLE_MASTERHAND),
                                0,
                                0,
                                false,
                                false,
                    ...
                    if ModelModule::scale(module_accessor) == 0.0001 {
                        ...
                        if !CONFIG.options.wol_master_hand_normal.unwrap_or(false) {
                            ...
                            ) == false
                            {
                                if StatusModule::status_kind(boss_boma)
                                    != *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBIDEPPOU_START
                                    && StatusModule::status_kind(boss_boma)
                                        != *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBIDEPPOU_HOMING
                                    && StatusModule::status_kind(boss_boma)
                                        != *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBIDEPPOU
                                    && StatusModule::status_kind(boss_boma)
                                        != *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBIDEPPOU_END
                                {
                        ...
                        if FighterManager::is_result_mode(fighter_manager) == true {
                            ...
                            SoundModule::stop_se(
                                module_accessor,
                                Hash40::new("se_mario_jump01"),
                                0,
                            );
                            SoundModule::stop_se(
                                module_accessor,
                                Hash40::new("se_mario_landing02"),
                                0,
                            );
                        }
                        ...
                        {
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBI_BEAM
                            {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_TURN
                            {
                                //Boss Control Stick Movement
                                // X Controllable
                                if CONTROLLER_X
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_YUBIPACCHIN_END
                            {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_HIPPATAKU
                            {
                                if MotionModule::frame(boss_boma)
                                    >= MotionModule::end_frame(boss_boma) - 5.0
                                {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_IRON_BALL_END
                            {
                                if MotionModule::frame(boss_boma)
                                    >= MotionModule::end_frame(boss_boma) - 5.0
                                {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_CHAKRAM_END
                            {
                                if MotionModule::frame(boss_boma)
                                    >= MotionModule::end_frame(boss_boma) - 5.0
                                {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_DRILL_END
                            {
                                if MotionModule::frame(boss_boma)
                                    >= MotionModule::end_frame(boss_boma) - 5.0
                                {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_PAA_TSUBUSHI_END
                            {
                                if MotionModule::frame(boss_boma)
                                    >= MotionModule::end_frame(boss_boma) - 5.0
                                {
                            ...
                            if StatusModule::status_kind(boss_boma)
                                == *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_MOVE
                            {
                                let x = PostureModule::pos_x(boss_boma);
                                let y = PostureModule::pos_y(boss_boma);
                                let z = PostureModule::pos_z(boss_boma);
                                let boss_pos = Vector3f { x: x, y: y, z: z };
                                let boss_pos_2 = Vector3f {
                                    x: x,
                                    y: y + 20.0,
                                    z: z,
                                };
                                ...
                                && !DEAD
                            {
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_IRON_BALL_START,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_CHAKRAM_START,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_PAA_TSUBUSHI_HOLD,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_DRILL_START,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_PLAYABLE_MASTERHAND_STATUS_KIND_HIPPATAKU_HOLD,
                                        true,
                                    );
                                }
                            }

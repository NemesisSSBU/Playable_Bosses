...
static mut FIGHTER_NAME: [u64; MAX_PLAYERS] = [0; MAX_PLAYERS];

static GALLEOM_NAME_HASHES: Lazy<[u64; 6]> = Lazy::new(|| {
    [
        hash40("GALLEOM"),
        hash40("ガレオム"),
        hash40("GALÉON"),
...
#[inline(always)]
fn is_galleom_name(hash: u64) -> bool {
    GALLEOM_NAME_HASHES
        .iter()
...
extern "C" fn once_per_fighter_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if fighter_kind == *FIGHTER_KIND_MARIO {
            ...
            let is_galleom_selection = selected_hash == hash40("ui_chara_galleom");
            let fallback_name_match =
                selected_hash == 0 && is_galleom_name(FIGHTER_NAME[player_number]);

            if !(is_galleom_selection || fallback_name_match) {
            ...
            if smash::app::stage::get_stage_id() == 0x139 {
                        ...
                        if CONTROLLABLE == true {
                            if MotionModule::motion_kind(boss_boma) != smash::hash40("wait")
                                ...
                                && StatusModule::status_kind(boss_boma)
                                    != *ITEM_GALLEOM_STATUS_KIND_ANGER
                            {
                                if StatusModule::status_kind(module_accessor)
                                    != *ITEM_GALLEOM_STATUS_KIND_WALK_FRONT
                                    || StatusModule::status_kind(module_accessor)
                                        != *ITEM_GALLEOM_STATUS_KIND_WALK_BACK
                                {
                                    if MOVING == false {
                                        if FRESH_CONTROL {
                                            StatusModule::change_status_request_from_script(
                ...
                if sv_information::is_ready_go() == true {
                    if DEAD == true {
                        ...
                        if MotionModule::frame(boss_boma) > 150.0 {
                            HitModule::set_whole(
                                module_accessor,
                ...
                )) == false
                {
                    ...
                    if StatusModule::status_kind(boss_boma) == *ITEM_GALLEOM_STATUS_KIND_ANGER {
                        CONTROLLABLE = false;
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 1.0
                        {
                            CONTROLLABLE = true;
                            FRESH_CONTROL = true;
                        }
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_HAMMER_KNUCKLE
                    {
                        if MotionModule::frame(boss_boma)
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_RUSH_RETURN_TRANSFORM
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_GRAB_CRUSH_MISS
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_DOUBLE_LARIAT_MAIN
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_RUSH_FALL_RETURN_TRANSFORM
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_LARGE_JUMP_LANDING
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                    ...
                    if StatusModule::status_kind(boss_boma)
                        == *ITEM_GALLEOM_STATUS_KIND_DOUBLE_ARM_PRESS
                    {
                        if MotionModule::frame(boss_boma)
                            >= MotionModule::end_frame(boss_boma) - 5.0
                        {
                            ...
                            if sv_information::is_ready_go() == true {
                                ...
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_JUMP,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_RUSH_FALL_TRANSFORM,
                                        true,
                                    );
                                }
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_SPECIAL,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_SHOOT_START,
                                        true,
                                    );
                                }
                                if ControlModule::check_button_on(
                                ...
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_ATTACK,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_UPPERCUT,
                                        true,
                                    );
                                }
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_RUSH_TRANSFORM,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_TURN_GRAB,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_DOUBLE_LARIAT_SQUAT,
                                        true,
                                    );
                                }
                                if ControlModule::get_command_flag_cat(fighter.module_accessor, 0)
                                    ...
                                    != 0
                                {
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_LARGE_JUMP_SQUAT,
                                        true,
                                    );
                                }
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_APPEAL_LW,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_FALL_DOWN,
                                        true,
                                    );
                                }
                                if ControlModule::check_button_on(
                                ...
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_APPEAL_S_L,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_STEP_CRUSH,
                                        true,
                                    );
                                }
                                if ControlModule::check_button_on(
                                    ...
                                    *CONTROL_PAD_BUTTON_APPEAL_S_R,
                                    ...
                                    StatusModule::change_status_request_from_script(
                                        boss_boma,
                                        *ITEM_GALLEOM_STATUS_KIND_MISSILE,
                                        true,
                                    );
                                }
                            }
